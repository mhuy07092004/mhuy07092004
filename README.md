...
- 🌐 **Core Programming Languages:** [**JavaScript**](https://developer.mozilla.org/en-US/docs/Web/JavaScript), [**Python**](https://www.python.org/)
- 📚 **Currently Learning:** Backend Development & Deployment processes
